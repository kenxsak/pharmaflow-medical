...
public class JwtService {
    ...
    public String generateToken(UserDetails employer) {
        return generateToken(employer, Collections.emptyMap());
    }

    public String generateToken(UserDetails employer, Map<String, Object> extraClaims) {
        return generateToken(employer, extraClaims, employer.getUsername());
    }

    public String generateToken(UserDetails employer, Map<String, Object> extraClaims, String subject) {
        return Jwts.builder()
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        final String resolvedUsername = subject != null && subject.contains("|")
                ? subject.substring(subject.indexOf('|') + 1)
                : subject;
        return resolvedUsername != null && resolvedUsername.equals(userDetails.getUsername());
    }
