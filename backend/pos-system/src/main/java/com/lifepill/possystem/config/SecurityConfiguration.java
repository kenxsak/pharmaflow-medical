...
import com.pharmaflow.tenant.TenantScopeFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(req ->
                        req.antMatchers("/lifepill/v1/auth/**",
                                ...
                                .permitAll()
                                .antMatchers("/api/v1/platform/**")
                                .hasRole(PharmaRoleName.SUPER_ADMIN.name())
                                .antMatchers("/api/v1/stores/**")
                                .hasAnyRole(
                                ...
                                .antMatchers("/api/v1/medicines/**", "/api/v1/inventory/**", "/api/v1/billing/**")
                                .hasAnyRole(
                                        PharmaRoleName.SUPER_ADMIN.name(),
                                        PharmaRoleName.STORE_MANAGER.name(),
                                        PharmaRoleName.PHARMACIST.name(),
                ...
                .addFilterAfter(tenantScopeFilter, JwtAuthFilter.class)
                .build();
    }
}
