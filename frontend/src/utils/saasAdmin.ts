...
const DEFAULT_TENANTS: TenantRecord[] = [
  ...
  },
  {
    ...
    notes: 'Reference tenant for enterprise demo, receipts, and buyer coverage.',
  },
  {
    id: 'tenant-medinone-legacy',
    brandName: 'MedInOne Legacy',
    slug: 'medinone-legacy',
    status: 'Pilot',
    planId: 'growth',
    billingCycle: 'Monthly',
    storeCount: 10,
    activeUsers: 96,
    deploymentMode: 'Legacy branch-first operations',
    supportEmail: 'support@medinone.in',
