...
const DEFAULT_PLANS: PlanRecord[] = [
  {
    id: 'launch',
    name: 'Launch',
    description: 'For a single pharmacy or a very small pilot account.',
  ...
  },
  {
    ...
    bestFor: '25 to 300 stores with stronger visibility and support.',
  ...
  },
  {
    ...
    description: 'For chains needing delivery, integrations, support services, and 24x7 coverage.',
...
const DEFAULT_TENANTS: TenantRecord[] = [
  {
    ...
    notes: 'Tamil Nadu enterprise chain account with HO, warehouse, and branch expansion plan.',
  },
  {
    id: 'tenant-medinone',
    brandName: 'MedInOne',
    ...
    activeUsers: 65,
    deploymentMode: 'Hybrid cloud + branch-local operations',
    supportEmail: 'support@medinone.in',
    supportPhone: '+91 44 4000 9000',
    billingEmail: 'finance@medinone.in',
    gstin: '33AABCP1234A1Z5',
    renewalDate: '2027-03-31',
    monthlyRecurringRevenueInr: 199999,
    notes: 'Reference tenant for enterprise operations, receipts, and buyer coverage.',
  },
  {
    id: 'tenant-medinone-branch',
    brandName: 'MedInOne Branch',
    slug: 'medinone-branch',
    status: 'Pilot',
    planId: 'growth',
    billingCycle: 'Monthly',
    storeCount: 10,
    activeUsers: 96,
    deploymentMode: 'Branch-first operations',
    supportEmail: 'support@medinone.in',
    supportPhone: '+94 11 700 5000',
    billingEmail: 'ops@medinone.in',
    gstin: 'N/A',
    renewalDate: '2026-05-01',
    monthlyRecurringRevenueInr: 39999,
    notes: 'Branch login and cashier flow used for compatibility validation.',
  },
];
